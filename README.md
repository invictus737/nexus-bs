...
# OTA update is disabled in Nexus-BS v0.1.63.
...
Nexus-BS v0.1.63 includes an operator-triggered WAP MVP carried as SDS Type4. This is not a full SNDCP/IP packet-data bearer, so keep `sndcp_service = false` unless that bearer is implemented and verified.
