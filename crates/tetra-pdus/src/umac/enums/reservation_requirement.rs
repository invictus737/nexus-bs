...
pub enum ReservationRequirement {
    ...
    Req34Slots = 12,
    Req51Slots = 13,
    /// Value 14 in the general reservation requirement field.
    Req68Slots = 14,
    /// Value 15 in the general field, or value 14 in MAC-U-BLCK where ETSI
    /// table 21.94 encodes "68 or more slots required".
    ReqOver68 = 15,
    // MAC-U-BLCK value 15 is "No reservation requirement".
}
