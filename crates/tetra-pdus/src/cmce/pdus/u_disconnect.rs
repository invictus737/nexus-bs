...
impl UDisconnect {
    fn validate(&self) -> Result<(), PduParseErr> {
        // EN 300 392-2 clause 14.7.2.4 / table 14.36 define the call
...
mod tests {
    ...
    #[test]
    fn u_disconnect_rejects_overwide_call_identifier() {
        let pdu = UDisconnect {
        ...
        // EN 300 392-2 clause 14.7.2.4: U-DISCONNECT call identifier is 14 bits.
        assert_eq!(
