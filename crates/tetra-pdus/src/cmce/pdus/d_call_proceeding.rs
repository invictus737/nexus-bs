...
impl DCallProceeding {
    fn validate(&self) -> Result<(), PduParseErr> {
        // EN 300 392-2 clause 14.7.1.2 / table 14.5 uses a 14-bit
...
mod tests {
    ...
    fn base_d_call_proceeding() -> DCallProceeding {
        DCallProceeding {
    ...
    fn serialize_err(pdu: &DCallProceeding) -> PduParseErr {
    ...
    #[test]
    fn d_call_proceeding_rejects_overwide_call_identifier() {
        let pdu = DCallProceeding {
            call_identifier: 0x4000,
            ..base_d_call_proceeding()
        };
    ...
    #[test]
    fn d_call_proceeding_rejects_overwide_notification_indicator() {
        let pdu = DCallProceeding {
