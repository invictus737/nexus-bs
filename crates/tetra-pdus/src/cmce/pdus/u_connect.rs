...
impl UConnect {
    fn validate(&self) -> Result<(), PduParseErr> {
        // EN 300 392-2 clause 14.7.2.3 / table 14.23 fixes the Call
        // identifier to 14 bits. Basic service information remains 8 bits.
...
mod tests {
    ...
    #[test]
    fn u_connect_rejects_overwide_call_identifier() {
        let pdu = UConnect {
