...
/// Full stack version string, e.g. "v0.1.68_dev-g2aad62c"
...
mod tests {
    ...
    fn product_identity_tracks_workspace_version() {
        ...
        assert_eq!(PRODUCT_BASE_VERSION, "0.1.68");
        assert_eq!(PRODUCT_VERSION_SUFFIX, "_dev");
        assert_eq!(PRODUCT_VERSION, "0.1.68_dev");
        assert_eq!(PRODUCT_VERSION_TAG, "v0.1.68_dev");
        assert_eq!(PRODUCT_USER_AGENT, "Nexus-BS/v0.1.68_dev");
