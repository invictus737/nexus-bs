...
mod tests {
    ...
    fn product_template_renders_current_nexus_bs_identity() {
        ...
        assert!(rendered.contains("Nexus-BS v0.1.56"));
    ...
    fn dashboard_product_identity_tracks_workspace_version() {
        ...
        assert_eq!(product.version, "0.1.56");
        assert_eq!(product.version_tag, "v0.1.56");
        assert_eq!(product.user_agent, "Nexus-BS/v0.1.56");
    }
