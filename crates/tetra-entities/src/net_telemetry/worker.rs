...
mod tests {
    ...
    /// connected to a locally running `nexus-bs-telemetry` on `ws://127.0.0.1:9001`.
    ...
    /// connected to a locally running `nexus-bs-telemetry-quic` on `127.0.0.1:4434`.
    ...
    /// ./target/debug/nexus-bs-telemetry-service --listen 127.0.0.1:19001 --auth-file /tmp/test_authfile.txt
    /// ```
    ///
