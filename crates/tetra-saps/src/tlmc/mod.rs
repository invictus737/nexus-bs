...
pub struct TlmcEnergyEconomyStartpoint {
    pub frame: u8,
    pub multiframe: u8,
}
...
pub struct TlmcConfigureReq {
    ...
    /// Local target for applying the energy economy group/startpoint to UMAC.
    /// ETSI 23.7.6 carries the group and startpoint through TL/TMC-CONFIGURE;
    /// this implementation also needs the local ISSI context because SAP
    /// messages are not sent over the air.
    pub energy_economy_issi: Option<u32>,
    pub energy_economy_group: Option<u8>,
    pub energy_economy_startpoint: Option<TlmcEnergyEconomyStartpoint>,
    pub dual_watch_energy_economy_group: Option<u8>,
    pub dual_watch_startpoint: Option<TlmcEnergyEconomyStartpoint>,
